...
const modules = [
    {
        ...
        description: 'Conta corrente, poupança, VR, vale-transporte — tudo no mesmo painel. Sem pular entre 5 apps de banco.',
        bullets: ['Extrato unificado', 'Entradas e saídas separadas', 'Organização por categoria'],
    ...
    },
    {
        ...
        description: 'Saiba quanto a fatura vai dar antes de fechar. Parcelas na linha do tempo e limite sempre visível.',
        bullets: ['Limite atualizado', 'Parcelas mapeadas', 'Alerta antes do vencimento'],
    ...
    },
    {
        ...
        description: 'Viagem, entrada do apartamento, reserva de emergência — defina o valor, acompanhe o progresso.',
    ...
    {
        id: 'projecao',
        title: 'Visão do Mês Inteiro',
        description: 'Nosso algoritmo cruza entradas e saídas e projeta seu saldo futuro. Você age antes do problema chegar.',
        bullets: ['30, 60 ou 90 dias à frente', 'Alerta de risco no momento certo', 'Decisão antes do aperto'],
...
const journey = [
    {
        ...
        description: 'Informe suas contas bancárias e dívidas uma única vez. Leva 2 minutos.',
    ...
    },
    {
        ...
        description: 'Tirou do bolso? Registra no app. Rápido como mandar uma mensagem.',
    ...
    },
    {
        ...
        description: 'O painel acende quando o saldo fica apertado. Você age antes do furo.',
        colSpan: 'col-span-1 md:col-span-1 lg:col-span-2',
        height: 'min-h-[240px]',
        accent: 'amber',
    },
    {
        number: '4',
        title: 'Ajuste e respire',
        description: 'Corte um gasto aqui, adie uma compra ali. O mês fecha no azul.',
        colSpan: 'col-span-1 md:col-span-2 lg:col-span-3',
        height: 'min-h-[280px]',
        accent: 'emerald',
    },
...
const personas = [
    ...
    'CLT que sempre estoura o cartão',
    'Quem desistiu das planilhas',
];
</script>

<template>
    <Head title="Produto | Kitamo">
        <meta name="description" content="Por dentro do Kitamo: contas, cartões, metas e projeção de caixa em um lugar só." />
    </Head>
    ...
    <SiteLayout :can-login="canLogin" :can-register="canRegister">
        ...
        <MotionSection class="relative min-h-[90vh] w-full bg-slate-950 text-white flex items-center pt-32 pb-24 overflow-hidden">
            ...
            <div class="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div class="absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full bg-teal-600/15 blur-[150px] mix-blend-screen opacity-60 animate-pulse"></div>
        ...
        <MotionSection class="bg-slate-50 py-24 pb-32 overflow-hidden">
            <div class="mx-auto w-full max-w-[1440px] px-6 md:px-12">
                <div class="text-center mb-20 md:mb-32">
                    <p class="inline-flex items-center space-x-2 text-[10px] font-bold uppercase tracking-[0.2em] text-teal-600 mb-4 bg-teal-50 px-4 py-2 rounded-full border border-teal-100">Os Pilares</p>
                    <h2 class="text-4xl sm:text-5xl font-extrabold tracking-tighter text-slate-900 leading-[1.05]">
                        Cada módulo resolve<br><span class="font-serif italic text-teal-500">um problema real.</span>
                    </h2>
                </div>
        ...
        <MotionSection class="bg-slate-950 py-32 text-white relative z-10 border-t border-slate-800 rounded-b-[4rem] shadow-2xl">
            ...
            <div class="mx-auto w-full max-w-[1440px] px-6 md:px-12 relative z-10">
                <div class="text-center mb-16">
                    <p class="inline-flex items-center space-x-2 text-[10px] font-bold uppercase tracking-[0.2em] text-teal-400 mb-4 bg-slate-900 border border-slate-800 px-4 py-2 rounded-full shadow-[0_0_20px_theme(colors.teal.500/10)] text-center">Sua Rotina no App</p>
                    <h2 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tighter text-white leading-[1.05] max-w-3xl mx-auto">
                        10 minutos por dia que<br><span class="font-serif italic text-teal-400 pr-2">salvam o mês inteiro.</span>
                    </h2>
                </div>
            ...
            <div class="mx-auto w-full max-w-[1440px] px-6 md:px-12 relative z-10 grid gap-20">
                <div class="text-center max-w-3xl mx-auto">
                    <h2 class="text-5xl sm:text-6xl lg:text-[5rem] font-extrabold tracking-tighter leading-[0.95] text-teal-950 mb-8 drop-shadow-sm">
                        Feito pra quem<br><span class="font-serif italic text-white pr-2">quer paz no bolso.</span>
                    </h2>
                </div>
                ...
                <div class="flex flex-wrap justify-center gap-4 max-w-5xl mx-auto mb-16">
                    <div
                        ...
                        :key="item"
                        class="flex items-center gap-3 text-sm sm:text-lg font-bold bg-white/20 backdrop-blur-md px-6 py-4 rounded-[1.5rem] border border-white/30 text-teal-950 shadow-sm hover:scale-105 transition-transform cursor-default"
                    >
                ...
                <div class="flex flex-col items-center justify-center text-center max-w-2xl mx-auto bg-slate-950 p-10 md:p-14 rounded-[3rem] shadow-2xl relative border border-slate-800 hover:-translate-y-2 transition-transform duration-500">
                    ...
                    <h3 class="text-3xl sm:text-4xl font-extrabold text-white mb-4 tracking-tight relative z-10">Comece agora, é grátis.</h3>
                    <p class="text-slate-400 font-medium mb-10 text-lg relative z-10">Montar seu painel financeiro no Kitamo leva menos de 2 minutos.</p>
