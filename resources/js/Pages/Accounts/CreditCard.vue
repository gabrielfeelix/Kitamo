    ...
    <SorsLayout v-else title="Visão Geral" :subtitle="`Bem-vindo de volta, ${userName}.`">
        <div class="space-y-6">
            <div class="flex items-center gap-4">
                ...
                <div class="text-2xl font-semibold text-slate-900">Nubank Cartão</div>
            </div>
            ...
            <div class="grid gap-6 xl:grid-cols-[420px_1fr]">
                <div class="rounded-[28px] border border-white/70 bg-white p-6 shadow-[0_20px_50px_-40px_rgba(15,23,42,0.4)]">
                    ...
                    <button class="mt-10 w-full rounded-2xl py-3 text-sm font-semibold text-slate-900" type="button">
                        Pagar Fatura
                    </button>
                </div>
